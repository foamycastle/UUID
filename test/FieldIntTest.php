...
class FieldIntTest extends TestCase
{
    ...
    function test__toString()
    {
        ...
        $fieldIntLow  = new FieldInt(32, 0, 8, 0);
        $fieldIntLow->setProvider($gregorianTime);
        $fieldIntMid  = new FieldInt(16,$fieldIntLow,4,32);
        $fieldIntHigh  = new FieldInt(12,$fieldIntLow,3,48);
        $this->assertIsString((string)$fieldIntLow);
